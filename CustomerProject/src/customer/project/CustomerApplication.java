...
//		findCustomer(10050);
		...
		showPriceBonus(customerKim, 10000);
	}
...
//			if(customer.getCustomerGrade().equals("VIP")) {
//				System.out.println(customer.getCustomerName()+"님의 등급: " +customer.getCustomerGrade() + ", 보너스 포인트: "+customer.bonusPoint + "점"+"담당 상담원 번호: ");
//			}
			System.out.println(customer.getCustomerName()+"님의 등급: " +customer.getCustomerGrade() + ", 보너스 포인트: "+customer.bonusPoint + "점");
		}
	}
	/*
...
//	}
   ...
   보너스 포인트를 보너스 포인트 계산하는 showPriceBonus 메소드를 완성하시오.
	...
	public static void showPriceBonus(Customer customer, int price) {
		...
		System.out.println(customer.getCustomerName()+"님의" + "지불금액: " + customer.calcPrice(price));
